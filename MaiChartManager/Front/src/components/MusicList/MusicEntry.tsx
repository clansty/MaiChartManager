...
export default defineComponent({
  ...
  setup(props) {
    ...
    return () => (
      <div class={`flex gap-5 h-20 w-full p-2 m-y-1 hover:bg-zinc-2 rd-md select-none ${props.selected && 'bg-[var(--selected-bg)]'}`} onClick={props.onClick} title={props.music.name!}>
